...
# 2. Start the settings GUI (using the internal virtual environment)
sudo ./venv/bin/python3 settings_gui.py
...
# 2. Einstellungen starten (unter Verwendung der internen virtuellen Umgebung)
sudo ./venv/bin/python3 settings_gui.py
